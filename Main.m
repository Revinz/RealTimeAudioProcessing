...
% Checks if a socket is selected after a socket has been selected already
            if selectedObject.isSocket == true
                ...
                if selectCount == 2                    
                    prevObject.select();
                    prevObject.connectLine(prevObject,selectedObject);
                    selectCount = 0;
